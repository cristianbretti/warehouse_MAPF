...
def main():
	...
	number_of_tests = number_of_tests - (impossible_problems_WHCA + impossible_problems_DKBR + impossible_problems_RND)
	...
	tree_fail_file = open("tree_fail_file.txt", 'w')
